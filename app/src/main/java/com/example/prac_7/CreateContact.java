...
public class CreateContact extends Fragment {
    ...
    public static CreateContact newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // int Number=Integer.parseInt(n1);
        ArrayList<myData2> contactList=viewModel.getmyData();
        Button saveContact=rootView.findViewById(R.id.saveContactButton);
        saveContact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                myData2 newContact= new myData2(name.getText().toString(),number.getText().toString());
                contactList.add(newContact);
                viewModel.setmyData(contactList);
